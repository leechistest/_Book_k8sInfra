...
jvopt2="-Dcasc.jenkins.config=https://raw.githubusercontent.com/leechistest/_Book_k8sInfra/main/ch5/5.3.1/jenkins-config.yaml"
#jvopt2="-Dcasc.jenkins.config=/root/_Book_k8sInfra/ch5/5.3.1/jenkins-config.yaml"
